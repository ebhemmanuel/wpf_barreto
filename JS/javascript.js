...
//%ofinscrease * by averange

    function rollingAv  () {

        var lastSale       = [];
            lastSale[0]    = parseInt(prompt());
            lastSale[1]    = parseInt(prompt());
            lastSale[2]    = parseInt(prompt());

       var lastCycle       = lastSale[0]+lastSale[1]+lastSale[2]/3;

        var currentSales   = [];
         currentSales[0]   = parseInt(prompt());
         currentSales[1]   = parseInt(prompt());
         currentSales[2]   = parseInt(prompt());

        var currentCycle   = currentSales1+currentSales2+currentSales3/3;
        var percentIncrease= []
